            ...
            if let trip {
                List {
                    ...
                    Section("Stats") {
                        ...
                        summaryRow("Avg speed", "\(Int(trip.avgSpeed.rounded())) km/h", colors: colors)
                        summaryRow("Max speed", String(format: "%.1f km/h", trip.maxSpeed), valueColor: colors.neonBlue, colors: colors)
